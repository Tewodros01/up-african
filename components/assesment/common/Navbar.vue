...
<template>
  <div class="hidden md:flex min-h-screen w-36 border-r-4">
    <div class="h-full bg-white fixed overflow-y-auto">
      <ul class="menu p-4 gap-4">
        <li>
          <router-link
            to="/assesmentdashboard"
            :class="[
              'flex flex-col items-center p-2 rounded-lg transition-all duration-200',
              isActive('/assesmentdashboard')
        ...
        <li>
          ...
          >
            ...
            <p class="text-xs font-semibold">Assessment</p>
          </router-link>
        </li>
        <li>
          <router-link
          ...
          >
            ...
            <p class="text-xs font-semibold">My Library</p>
          </router-link>
        </li>
        <li>
          <router-link
          ...
          >
            ...
            >
              <path
                d="M7.333 10.5a.833.833 0 110 1.667H5.833a.833.833 0 010-1.667h1.5zm0-5a.833.833 0 110 1.667H5.833a.833.833 0 010-1.667h1.5zm5 5a.833.833 0 110 1.667h-1.5a.833.833 0 110-1.667h1.5zm0-5a.833.833 0 110 1.667h-1.5a.833.833 0 110-1.667h1.5zm4.334-3.666H3.333A2.833 2.833 0 00.5 4.333v12.334A2.833 2.833 0 003.333 19.5h13.334A2.833 2.833 0 0019.5 16.667V4.333A2.833 2.833 0 0016.667 1.5zm.833 15.167a.833.833 0 01-.833.833H3.333a.833.833 0 01-.833-.833V4.333a.833.833 0 01.833-.833h13.334a.833.833 0 01.833.833v12.334z"
              />
            </svg>
            <p class="text-xs font-semibold">My Listings</p>
          </router-link>
        </li>
        <li>
          <router-link
          ...
          >
            ...
            >
              <path
                d="M10 11.5a3.833 3.833 0 100-7.666 3.833 3.833 0 000 7.666zm0-1.667a2.167 2.167 0 110-4.334 2.167 2.167 0 010 4.334zm0 2.5c-2.683 0-8.167 1.344-8.167 4.034V18.5h16.334v-2.133c0-2.69-5.484-4.034-8.167-4.034zm-6.5 4.034c.16-.677 3.394-2.367 6.5-2.367s6.34 1.69 6.5 2.367v.466H3.5v-.466z"
              />
            </svg>
            <p class="text-xs font-semibold">HR Panel</p>
          </router-link>
        </li>
        <li>
          <router-link
          ...
          >
            ...
            >
              <path
                d="M5.5 3a1 1 0 100 2h1v-.5a1 1 0 112 0V5h2v-.5a1 1 0 112 0V5h1a1 1 0 100-2h-8zm-3 7v8.5a.5.5 0 00.5.5h14a.5.5 0 00.5-.5V10h-15zm2 3.667a.667.667 0 111.333 0 .667.667 0 01-1.333 0zm2.5 0a.667.667 0 111.333 0 .667.667 0 01-1.333 0zm2.5 0a.667.667 0 111.333 0 .667.667 0 01-1.333 0zm2.5 0a.667.667 0 111.333 0 .667.667 0 01-1.333 0zm2.5 0a.667.667 0 111.333 0 .667.667 0 01-1.333 0z"
              />
            </svg>
            <p class="text-xs font-semibold">My Festivals</p>
          </router-link>
        </li>
        <li>
          <router-link
          ...
          >
            ...
            >
              <path
                d="M4.5 4h11a.5.5 0 01.5.5v12a.5.5 0 01-.5.5h-11a.5.5 0 01-.5-.5v-12a.5.5 0 01.5-.5zM4 3a1.5 1.5 0 00-1.5 1.5v12A1.5 1.5 0 004 18h11a1.5 1.5 0 001.5-1.5v-12A1.5 1.5 0 0015 3H4zm2 2.5a.5.5 0 011 0v.5h5v-.5a.5.5 0 011 0v.5h1.5v2H4.5v-2H6v-.5zm-1.5 6v-1h11v1H4.5zm0 4v-1h11v1H4.5z"
              />
            </svg>
            <p class="text-xs font-semibold">Plans & Billings</p>
          </router-link>
        </li>
      </ul>
    </div>
