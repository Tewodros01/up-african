...
// Function to handle focus and blur of the search input
...
<template>
  <!-- Main Header -->
  <div
    class="bg-white w-full flex justify-center items-baseline md:items-center h-[6rem] md:h-[4rem] border-b border-slate-200 fixed top-0 z-[20]"
  >
    <div
    ...
    >
      ...
      <div class="flex justify-end md:justify-between items-center md:divide-x">
        <div
          ...
          class="hidden sm:flex items-center h-full relative"
        >
          ...
          <CommonMenuItemLayout
            ...
            :icon="Award"
          />
          <CommonMenuItemLayout href="/company" text="Company" :icon="Grid" />
          <CommonMenuItemLayout
            href="/upafricanpro"
            text="UpAfrican Pro"
            :icon="Gem"
        ...
        <div class="flex items-center px-2 space-x-2">
          <NuxtLink
            ...
            :class="[
              ...
              pathname.includes('/host') && 'bg-blue-500 text-white',
            ]"
          >
            <Plus class="w-4 h-4" />
            <span>Host</span>
    ...
    >
      <CommonMenuItemLayout :icon="BriefcaseBusiness" text="Jobs" href="/job" />
      <CommonMenuItemLayout
        href="/scholarship"
        text="Scholarships"
        :icon="Award"
