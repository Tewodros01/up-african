...
<template>
  <div class="w-full border rounded-lg">
    <div class="flex justify-between items-start p-3">
      <div class="flex gap-2">
        ...
        <div class="lg:hidden mt-1">
          <h2 class="text-sm text-[#1C4980] font-semibold">{{ title }}</h2>
          <div class="flex gap-2 items-center text-[#1C4980]">
            <p class="font-semibold text-sm">Job</p>
            <div class="h-[1rem] w-[1px] bg-[#DADCE0]"></div>
            <div class="flex gap-1 items-center">
              ...
              <p class="text-[#8DA4BF] text-xs font-medium">{{ date }}</p>
            </div>
          </div>
        </div>
      </div>
      <!-- card menu button -->
      <button class="rounded-full bg-transparent p-2 hover:bg-[#E5F1FC]">
        <svg
          xmlns="http://www.w3.org/2000/svg"
          width="20"
          height="20"
    ...
    <div class="px-3 pb-3">
      ...
      <h2 class="text-lg text-[#1C4980] font-medium hidden lg:block">
        {{ title }}
      </h2>
      <div class="gap-2 mt-2 pb-3 hidden lg:flex items-center text-[#1C4980]">
        <p class="font-semibold text-sm">Job</p>
        <div class="h-[1rem] w-[1px] bg-[#DADCE0]"></div>
        <div class="flex gap-1 items-center">
          <svg
      ...
      <!--  Footer of cards -->
      <div
        class="flex flex-wrap gap-y-2 justify-between items-center border-dashed border-t-[1.6px] pt-3"
      >
        <div class="flex gap-1 md:gap-2 leading-tight text-[#1C4980]">
          <p class="font-semibold text-sm">
            {{ duration }}
            <br />
            <span class="font-medium text-[0.625rem] md:text-xs">
              Duration
            </span>
          </p>
          <p class="font-semibold text-sm">
        ...
        <div class="flex gap-1 md:gap-2">
          <button
            class="rounded-full flex border items-center text-xs md:text-[0.875rem] gap-1 px-2 border-[#1C4980] font-medium text-[#1C4980] hover:bg-[#E5F1FC] transition-all"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="20"
          ...
          <div class="flex ml-4">
            <span
              class="bg-[#6548EE] rounded-full w-8 h-8 flex items-center justify-center text-white font-semibold border border-white -ml-4"
              >LP</span
            >
            <span
              class="bg-[#3079E1] rounded-full w-8 h-8 flex items-center justify-center text-white font-semibold border border-white -ml-4"
              >LP</span
            >
            <span
              class="bg-[#E9407A] rounded-full w-8 h-8 flex items-center justify-center text-white font-semibold border border-white -ml-4"
              >LP</span
            >
          </div>
        </div>
