<template>
  ...
  >
    <div class="collapse-content p-4 bg-white rounded-lg shadow-md">
      <div
        class="w-full rounded-box border mb-8 flex-wrap overflow-hidden flex"
      >
        <div class="flex w-full border-b">
          <div class="py-3 px-4 border-r w-1/2">
            <h4 class="text-[#1C4980] text-[0.875rem] font-semibold mb-3">
              Total Assessment
            </h4>
            <div class="flex gap-3 items-center">
              ...
              <h4 class="font-semibold text-base text-[#1C4980]">34</h4>
            </div>
          </div>
          <div class="py-3 px-4 w-1/2">
            <h4 class="text-[#1C4980] text-[0.875rem] font-semibold mb-3">
              Total Purpose
            </h4>
            <div class="flex gap-3 items-center">
              ...
              <h4 class="font-semibold text-base text-[#1C4980]">11</h4>
            </div>
          </div>
        </div>
        <div class="py-3 px-4 border-r flex-auto border-b w-full">
          <h4 class="text-[#1C4980] text-[0.875rem] font-semibold mb-3">
            Candidates
          </h4>
          <div class="flex flex-wrap gap-y-2">
            <div class="pr-3 flex gap-3 items-center">
              <div>
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="40"
              ...
              <div class="flex flex-col">
                <h4
                  class="font-semibold text-base text-[#1C4980] flex items-center gap-1"
                >
                  11,145 <span class="text-[#05C165] text-xs">+89</span>
                </h4>
            ...
            <div class="border-l pl-4 flex gap-3 items-center">
              <div class="flex flex-col">
                <h4
                  class="font-semibold text-base text-[#1C4980] flex items-center gap-1"
                >
                  1,14 <span class="text-[#05C165] text-xs">+89</span>
                </h4>
                <p class="text-xs font-medium text-[#1C4980]">Who Attempted</p>
              </div>
            </div>
          </div>
        </div>
        <div class="py-3 px-4 border-r flex-auto w-full">
          <h4 class="text-[#1C4980] text-[0.875rem] font-semibold mb-3">
            Candidates Source
          </h4>
          <div class="flex flex-wrap gap-y-2">
            <div class="pr-3 flex gap-2 items-center">
              ...
              <div class="flex flex-col">
                <h4
                  class="font-semibold text-base text-[#1C4980] flex items-center gap-1"
                >
                  11,000 <span class="text-[#05C165] text-xs">+89</span>
                </h4>
                <p class="text-xs font-medium text-[#1C4980]">E-mail</p>
              </div>
            </div>
            <div class="border-x px-3 flex gap-3 items-center">
              <div class="flex flex-col">
                <h4
                  class="font-semibold text-base text-[#1C4980] flex items-center gap-1"
                >
                  145 <span class="text-[#05C165] text-xs">+89</span>
                </h4>
                <p class="text-xs font-medium text-[#1C4980]">Social Share</p>
              </div>
            </div>
            <div class="pl-3 flex gap-3 items-center">
              <div class="flex flex-col">
                ...
                <p class="text-xs font-medium text-[#1C4980]">Unique Link</p>
              </div>
            </div>
          </div>
        </div>
