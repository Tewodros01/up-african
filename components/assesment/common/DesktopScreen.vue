<template>
  <div class="w-full rounded-box border mb-8 flex-wrap overflow-hidden flex">
    <div class="py-4 px-5 border-r">
      ...
      <div class="flex gap-3 items-center">
        ...
        <h4 class="font-bold text-xl text-[#1C4980]">34</h4>
      </div>
    </div>
      ...
      <div class="flex">
        <div class="border-r pr-4 flex gap-3 items-center">
          ...
          <div class="flex flex-col">
            ...
            <p class="text-xs font-medium text-[#1C4980]">Total Candidate</p>
          </div>
        </div>
        <div class="border-l pl-4 flex gap-3 items-center">
          <div class="flex flex-col">
            ...
            <p class="text-xs font-medium text-[#1C4980]">Who Attamped</p>
          </div>
        </div>
      </div>
    </div>
    <div class="py-4 px-5 border-r flex-auto">
      ...
      <div class="flex">
        ...
        <div class="border-x px-4 flex gap-3 items-center">
          <div class="flex flex-col">
            <h4
              class="font-bold text-xl text-[#1C4980] flex items-center gap-1"
            >
    ...
    <div class="py-4 px-5">
      ...
      <div class="flex gap-3 items-center">
        ...
        <h4 class="font-bold text-xl text-[#1C4980]">11</h4>
      </div>
    </div>
  </div>
</template>
